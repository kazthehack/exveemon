...
export const MONSTER_ROUTE_PATH =
    "./build/resources/data/monsterEvolutionRouter.json";

export const MONSTER_INFO_PATH =
    "./build/resources/data/monsterDataDetails.json";
...
export enum ACTION_STATE {
    ...
    REEAD_USER_INFO_SUCCESS = "READ_USER_INFO_PATH_SUCCESS"
}
